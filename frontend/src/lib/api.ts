...
export type Customer = { id:number; first_name:string; last_name?:string; email?:string; phone?:string; company?:string; avatar_url?:string; notes?:string; tags?:{id:number;name:string;color?:string}[] };
